...
function Login() {
    ...
    const register = e => {
        ...
        .then((auth) => {
            // It succesfully creates a new user with email and password
            if (auth) {
                navigate('/')
            }
        })
  ...
  return (
    <div className='login'>
        <Link to='/'>
            <img className='login__logo' src='https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/603px-Amazon_logo.svg.png?20220213013322' alt='Amazon-Logo' />
        </Link>
